...
class UserServiceClient extends \Grpc\BaseStub
{
    ...
    public function CheckUserExists(
        \App\Protobuf\Message\StringValue $argument,
        $metadata = [],
        $options = []
    )
    {
        return $this->_simpleRequest(
            '/intrvproto.UserService/CheckUserExists',
            $argument,
    ...
    public function GetUserById(
        \App\Protobuf\Message\GetUserRequest $argument,
        $metadata = [],
        $options = []
    )
    {
    ...
    public function VerifyUser(
        \App\Protobuf\Message\VerifyUserRequest $argument,
        $metadata = [],
        $options = []
    )
    {
    ...
    public function ChangePassword(
        \App\Protobuf\Message\ChangePasswordRequest $argument,
        $metadata = [],
        $options = []
    )
    {
    ...
    public function GetUser(
        \App\Protobuf\Message\GetUserSignInRequest $argument,
        $metadata = [],
        $options = []
    )
    {
        return $this->_simpleRequest(
            '/intrvproto.UserService/GetUser',
            $argument,
            ['\App\Protobuf\Message\UserDetails', 'decode'],
            $metadata,
            $options
    ...
    public function GetUserByCode(
        \App\Protobuf\Message\VerificationCode $argument,
        $metadata = [],
        $options = []
    )
    {
        return $this->_simpleRequest(
            '/intrvproto.UserService/GetUserByCode',
            $argument,
            ['\App\Protobuf\Message\UserDetails', 'decode'],
            $metadata,
            $options
    ...
    {
        return $this->_simpleRequest(
            '/intrvproto.UserService/GetUserByToken',
            $argument,
            ['\App\Protobuf\Message\UserDetails', 'decode'],
            $metadata,
            $options

...
-- Started on 2023-10-24 01:14:27 CEST
...
COMMENT ON SCHEMA interview IS 'standard testing schema';
...
ALTER TABLE interview.address_addressid_seq
    OWNER TO interview;
...
ALTER TABLE interview.cart_cart_id_seq
    OWNER TO interview;
...
ALTER TABLE interview.cart_item
    OWNER TO interview;
...
ALTER TABLE interview.cart_item_cart_item_id_seq
    OWNER TO interview;
...
ALTER TABLE interview.categories
    OWNER TO interview;
...
ALTER TABLE interview.categories_categoryid_seq
    OWNER TO interview;
...
ALTER TABLE interview.intrv_user
    OWNER TO interview;
...
ALTER TABLE interview.intrv_user_user_id_seq
    OWNER TO interview;
...
ALTER TABLE interview.oauth2_access_token
    OWNER TO interview;
...
ALTER TABLE interview.oauth2_authorization_code
    OWNER TO interview;
...
ALTER TABLE interview.oauth2_client
    OWNER TO interview;
...
ALTER TABLE interview.oauth2_client_profile
    OWNER TO interview;
...
ALTER TABLE interview.oauth2_client_profile_id_seq
    OWNER TO interview;
...
ALTER TABLE interview.oauth2_refresh_token
    OWNER TO interview;
...
ALTER TABLE interview.oauth2_user_consent
    OWNER TO interview;
...
ALTER TABLE interview.oauth2_user_consent_id_seq
    OWNER TO interview;
...
ALTER TABLE interview.order_item
    OWNER TO interview;
...
ALTER TABLE interview.order_item_order_item_id_seq
    OWNER TO interview;
...
ALTER TABLE interview.order_orderid_seq
    OWNER TO interview;
...
ALTER TABLE interview.order_pending
    OWNER TO interview;
...
ALTER TABLE interview.payment_paymentid_seq
    OWNER TO interview;
...
ALTER TABLE interview.plan_plan_id_seq
    OWNER TO interview;
...
ALTER TABLE interview.product_cart_item
    OWNER TO interview;
...
ALTER TABLE interview.products
    OWNER TO interview;
...
ALTER TABLE interview.products_productid_seq
    OWNER TO interview;
...
ALTER TABLE interview.subscription
    OWNER TO interview;
...
ALTER TABLE interview.subscription_cart_item
    OWNER TO interview;
...
ALTER TABLE interview.subscription_plan_cart_item
    OWNER TO interview;
...
ALTER TABLE interview.subscription_subscription_id_seq
    OWNER TO interview;
...
ALTER TABLE interview.suppliers
    OWNER TO interview;
...
ALTER TABLE interview.suppliers_supplier_id_seq
    OWNER TO interview;
...
ALTER TABLE interview.user_subscription
    OWNER TO interview;
...
ALTER TABLE interview.user_subscription_subscription_id_seq
    OWNER TO interview;
...
ALTER TABLE interview.voucher_voucher_id_seq
    OWNER TO interview;
...
ALTER TABLE ONLY interview.user_subscription
    ALTER COLUMN subscription_id SET DEFAULT nextval('interview.user_subscription_subscription_id_seq'::regclass);
...
ALTER TABLE ONLY interview.voucher
    ALTER COLUMN voucher_id SET DEFAULT nextval('interview.voucher_voucher_id_seq'::regclass);
...
INSERT INTO interview.cart_item
...
INSERT INTO interview.cart_item
VALUES (225, '2023-10-23 22:54:22', '2023-10-23 22:54:22', 'product', 23, 1, 75);
...
INSERT INTO interview.categories
...
INSERT INTO interview.intrv_user
...
INSERT INTO interview.oauth2_access_token
...
INSERT INTO interview.oauth2_authorization_code
...
INSERT INTO interview.oauth2_client
...
INSERT INTO interview.oauth2_client_profile
...
INSERT INTO interview.oauth2_refresh_token
...
INSERT INTO interview.oauth2_user_consent
...
INSERT INTO interview.order_item
VALUES (46,
...
INSERT INTO interview.product_cart_item
VALUES (41, 76);
INSERT INTO interview.product_cart_item
VALUES (42, 76);
INSERT INTO interview.product_cart_item
...
INSERT INTO interview.products
...
INSERT INTO interview.products
VALUES (11, 'Queso Cabrales', 5, 4, '1 kg pkg.', 2100, 11, 30, 1);
INSERT INTO interview.products
VALUES (75, 'Rhönbräu Klosterbier', 12, 1, '24 - 0.5 l bottles', 775, 124, 0, 3);
...
INSERT INTO interview.subscription
...
INSERT INTO interview.subscription_plan_cart_item
VALUES (50, 6);
INSERT INTO interview.subscription_plan_cart_item
VALUES (56, 6);
INSERT INTO interview.subscription_plan_cart_item
...
INSERT INTO interview.suppliers
...
-- Dependencies: 6
-- Name: SCHEMA interview; Type: ACL; Schema: -; Owner: pg_database_owner
--

GRANT ALL ON SCHEMA interview TO tester;


--
-- TOC entry 3623 (class 0 OID 0)
-- Dependencies: 215
-- Name: TABLE address; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.address TO tester;


--
-- TOC entry 3624 (class 0 OID 0)
-- Dependencies: 216
-- Name: SEQUENCE address_addressid_seq; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON SEQUENCE interview.address_addressid_seq TO tester;


--
-- TOC entry 3626 (class 0 OID 0)
-- Dependencies: 217
-- Name: TABLE cart; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.cart TO tester;


--
-- TOC entry 3627 (class 0 OID 0)
-- Dependencies: 218
-- Name: SEQUENCE cart_cart_id_seq; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON SEQUENCE interview.cart_cart_id_seq TO tester;


--
-- TOC entry 3628 (class 0 OID 0)
-- Dependencies: 219
-- Name: TABLE cart_item; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.cart_item TO tester;


--
-- TOC entry 3629 (class 0 OID 0)
-- Dependencies: 220
-- Name: SEQUENCE cart_item_cart_item_id_seq; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON SEQUENCE interview.cart_item_cart_item_id_seq TO tester;


--
-- TOC entry 3630 (class 0 OID 0)
-- Dependencies: 221
-- Name: TABLE categories; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.categories TO tester;


--
-- TOC entry 3631 (class 0 OID 0)
-- Dependencies: 222
-- Name: SEQUENCE categories_categoryid_seq; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON SEQUENCE interview.categories_categoryid_seq TO tester;


--
-- TOC entry 3632 (class 0 OID 0)
-- Dependencies: 223
-- Name: TABLE intrv_user; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.intrv_user TO tester;


--
-- TOC entry 3634 (class 0 OID 0)
-- Dependencies: 224
-- Name: SEQUENCE intrv_user_user_id_seq; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON SEQUENCE interview.intrv_user_user_id_seq TO tester;


--
-- TOC entry 3637 (class 0 OID 0)
-- Dependencies: 225
-- Name: TABLE oauth2_access_token; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.oauth2_access_token TO tester;


--
-- TOC entry 3640 (class 0 OID 0)
-- Dependencies: 226
-- Name: TABLE oauth2_authorization_code; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.oauth2_authorization_code TO tester;


--
-- TOC entry 3644 (class 0 OID 0)
-- Dependencies: 227
-- Name: TABLE oauth2_client; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.oauth2_client TO tester;


--
-- TOC entry 3645 (class 0 OID 0)
-- Dependencies: 228
-- Name: TABLE oauth2_client_profile; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.oauth2_client_profile TO tester;


--
-- TOC entry 3646 (class 0 OID 0)
-- Dependencies: 229
-- Name: SEQUENCE oauth2_client_profile_id_seq; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON SEQUENCE interview.oauth2_client_profile_id_seq TO tester;


--
-- TOC entry 3648 (class 0 OID 0)
-- Dependencies: 230
-- Name: TABLE oauth2_refresh_token; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.oauth2_refresh_token TO tester;


--
-- TOC entry 3652 (class 0 OID 0)
-- Dependencies: 231
-- Name: TABLE oauth2_user_consent; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.oauth2_user_consent TO tester;


--
-- TOC entry 3653 (class 0 OID 0)
-- Dependencies: 232
-- Name: SEQUENCE oauth2_user_consent_id_seq; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON SEQUENCE interview.oauth2_user_consent_id_seq TO tester;


--
-- TOC entry 3654 (class 0 OID 0)
-- Dependencies: 233
-- Name: TABLE order_item; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.order_item TO tester;


--
-- TOC entry 3655 (class 0 OID 0)
-- Dependencies: 234
-- Name: SEQUENCE order_item_order_item_id_seq; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON SEQUENCE interview.order_item_order_item_id_seq TO tester;


--
-- TOC entry 3656 (class 0 OID 0)
-- Dependencies: 235
-- Name: SEQUENCE order_orderid_seq; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON SEQUENCE interview.order_orderid_seq TO tester;


--
-- TOC entry 3657 (class 0 OID 0)
-- Dependencies: 236
-- Name: TABLE order_pending; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.order_pending TO tester;


--
-- TOC entry 3658 (class 0 OID 0)
-- Dependencies: 237
-- Name: TABLE orders; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.orders TO tester;


--
-- TOC entry 3659 (class 0 OID 0)
-- Dependencies: 238
-- Name: TABLE payment; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.payment TO tester;


--
-- TOC entry 3660 (class 0 OID 0)
-- Dependencies: 239
-- Name: SEQUENCE payment_paymentid_seq; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON SEQUENCE interview.payment_paymentid_seq TO tester;


--
-- TOC entry 3661 (class 0 OID 0)
-- Dependencies: 240
-- Name: TABLE plan; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.plan TO tester;


--
-- TOC entry 3663 (class 0 OID 0)
-- Dependencies: 241
-- Name: SEQUENCE plan_plan_id_seq; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON SEQUENCE interview.plan_plan_id_seq TO tester;


--
-- TOC entry 3664 (class 0 OID 0)
-- Dependencies: 242
-- Name: TABLE product_cart_item; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.product_cart_item TO tester;


--
-- TOC entry 3665 (class 0 OID 0)
-- Dependencies: 243
-- Name: TABLE products; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.products TO tester;


--
-- TOC entry 3666 (class 0 OID 0)
-- Dependencies: 244
-- Name: SEQUENCE products_productid_seq; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON SEQUENCE interview.products_productid_seq TO tester;


--
-- TOC entry 3667 (class 0 OID 0)
-- Dependencies: 245
-- Name: TABLE subscription; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.subscription TO tester;


--
-- TOC entry 3668 (class 0 OID 0)
-- Dependencies: 246
-- Name: TABLE subscription_cart_item; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.subscription_cart_item TO tester;


--
-- TOC entry 3669 (class 0 OID 0)
-- Dependencies: 247
-- Name: TABLE subscription_plan_cart_item; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.subscription_plan_cart_item TO tester;


--
-- TOC entry 3670 (class 0 OID 0)
-- Dependencies: 248
-- Name: SEQUENCE subscription_subscription_id_seq; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON SEQUENCE interview.subscription_subscription_id_seq TO tester;


--
-- TOC entry 3671 (class 0 OID 0)
-- Dependencies: 249
-- Name: TABLE suppliers; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.suppliers TO tester;


--
-- TOC entry 3672 (class 0 OID 0)
-- Dependencies: 250
-- Name: SEQUENCE suppliers_supplier_id_seq; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON SEQUENCE interview.suppliers_supplier_id_seq TO tester;


--
-- TOC entry 3673 (class 0 OID 0)
-- Dependencies: 251
-- Name: TABLE user_subscription; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.user_subscription TO tester;


--
-- TOC entry 3675 (class 0 OID 0)
-- Dependencies: 252
-- Name: SEQUENCE user_subscription_subscription_id_seq; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON SEQUENCE interview.user_subscription_subscription_id_seq TO tester;


--
-- TOC entry 3676 (class 0 OID 0)
-- Dependencies: 253
-- Name: TABLE voucher; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON TABLE interview.voucher TO tester;


--
-- TOC entry 3678 (class 0 OID 0)
-- Dependencies: 254
-- Name: SEQUENCE voucher_voucher_id_seq; Type: ACL; Schema: interview; Owner: interview
--

GRANT ALL ON SEQUENCE interview.voucher_voucher_id_seq TO tester;


--
-- TOC entry 2143 (class 826 OID 33797)
-- Name: DEFAULT PRIVILEGES FOR TABLES; Type: DEFAULT ACL; Schema: interview; Owner: interview
--

ALTER DEFAULT PRIVILEGES FOR ROLE interview IN SCHEMA interview GRANT ALL ON TABLES TO tester;


-- Completed on 2023-10-24 01:14:27 CEST

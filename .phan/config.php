...
return [
    ...
    'directory_list' => [
        ...
        'vendor/behat/behat/src/Behat/Hook',
        'vendor/behat/behat/src/Behat/Step',
        ...
        'vendor/codeception/module-symfony/src',
        'vendor/dama/doctrine-test-bundle/src/DAMA/DoctrineTestBundle',
        'vendor/dealerdirect/phpcodesniffer-composer-installer/src',
        ...
        'vendor/dq5studios/psalm-junit/src',
        'vendor/enlightn/security-checker/src',
        'vendor/ergebnis/composer-normalize/src',
        'vendor/ergebnis/phpstan-rules/src',
        ...
        'vendor/knpuniversity/oauth2-client-bundle/src',
        'vendor/league/climate/src',
        'vendor/league/oauth2-server-bundle/src',
        'vendor/league/oauth2-server/src',
        'vendor/nelmio/api-doc-bundle',
        'vendor/nelmio/cors-bundle',
        'vendor/nunomaduro/phpinsights/src',
        'vendor/open-telemetry/sdk',
        'vendor/orklah/psalm-insane-comparison',
        'vendor/pdepend/pdepend/src/main/php/PDepend',
        'vendor/phan/phan/src/Phan',
        'vendor/phing/phing/classes/phing',
        ...
        'vendor/php-standard-library/psalm-plugin/src',
        'vendor/phparkitect/phparkitect/src',
        'vendor/phpat/phpat/src',
        'vendor/phpbench/phpbench/extensions/xdebug/lib',
        'vendor/phpbench/phpbench/lib',
        'vendor/phpmd/phpmd/src/main/php',
        'vendor/phpmetrics/phpmetrics/./src',
        'vendor/phpro/grumphp-shim/src',
        'vendor/phpspec/phpspec/src',
        'vendor/phpstan/extension-installer/src',
        'vendor/phpstan/phpstan-beberlei-assert/src',
        'vendor/phpstan/phpstan-doctrine/src',
        'vendor/phpstan/phpstan-phpunit/src',
        'vendor/phpstan/phpstan-strict-rules/src',
        'vendor/phpstan/phpstan-symfony/src',
        'vendor/phpunit/phpunit/src',
        'vendor/povils/phpmnd/src',
        'vendor/psalm/plugin-mockery',
        'vendor/psalm/plugin-phpunit/src',
        'vendor/psalm/plugin-symfony/src',
        'vendor/rybakit/twig-deferred-extension/src',
        'vendor/shipmonk/phpstan-rules/src',
        'vendor/slevomat/coding-standard/SlevomatCodingStandard',
        'vendor/spaze/phpstan-disallowed-calls/src',
        'vendor/staabm/phpstan-dba/src',
        'vendor/stripe/stripe-php/lib',
        'vendor/symfony/amqp-messenger',
        ...
        'vendor/symfony/yaml',
        'vendor/symfonycasts/reset-password-bundle/src',
        'vendor/symfonycasts/verify-email-bundle/src',
        'vendor/symplify/coding-standard/src',
        'vendor/symplify/phpstan-extensions/src',
        'vendor/symplify/phpstan-rules/src',
        'vendor/tomasvotruba/cognitive-complexity/src',
        'vendor/tomasvotruba/type-coverage/src',
        'vendor/tomasvotruba/unused-public/src',
        'vendor/twig/extra-bundle',
        'vendor/twig/intl-extra',
        'vendor/vimeo/psalm/src/Psalm',
        'vendor/weirdan/doctrine-psalm-plugin/src',
    ],
    ...
    // project.
    'file_list' => [
        'vendor/codeception/codeception/src/PHPUnit/TestCase.php',
    ],
];
